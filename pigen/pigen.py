...
def chudnovsky_pi(n):
  """Generates digits of pi using Chudnovsky's series.

  Calculated as arbritrary length fixed point value.

  Args:
    n: The number of digits you wish to calculate.
  """
